...
for dataset in toy
do
    for sub_dataset in monumai coco catsdogscars pascalpart
    do
        ...
        do
            ...
            do 
                ...
                do
                    ...
                    python compute_criterion.py --criterion $criterion --expl_method $expl_method --network $network --input_dataset $dataset --sub_dataset $sub_dataset
                done
            done
