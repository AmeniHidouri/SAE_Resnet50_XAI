...
from pytorch_grad_cam import GradCAMElementWise as GradCAMElementWise_

import utils


class GradCAMElementWise:
    """Class that implements GradCAMElementWise explanation method for a given model."""

    def __init__(self, model, device):
        """Initializes GradCAMElementWise object.
        ...
        if model.name == "resnet50":
            ...
            self.explainer = GradCAMElementWise_(model=model, target_layers=target_layers)
            ...
            self.explainer = GradCAMElementWise_(
                model=model,
            ...
            print(f"Warning: GradCAMElementWise_ is not implemented for model {model.name}.")

    def compute_and_plot_explanation(self, image, **kwargs):
        """Compute GradCAMElementWise explanation and plot it.
        ...
        # Compute GradCAMElementWise explanation
