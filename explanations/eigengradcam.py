...
from pytorch_grad_cam import EigenGradCAM as EigenGradCAM_

import utils


class EigenGradCAM:
    """Class that implements EigenGradCAM explanation method for a given model."""

    def __init__(self, model, device):
        """Initializes EigenGradCAM_ object.
        ...
        if model.name == "resnet50":
            ...
            self.explainer = EigenGradCAM_(model=model, target_layers=target_layers)
            ...
            print(f"Warning: EigenGradCAM is not implemented for model {model.name}.")

    def compute_and_plot_explanation(self, image, **kwargs):
        """Compute EigenGradCAM explanation and plot it.
        ...
        # Compute EigenGradCAM explanation
