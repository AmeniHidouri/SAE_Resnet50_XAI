...
def precompute_images_vit(input_dir, output_dir):
    """
    Transforme les images d'un dataset pour ViT-B-16 et les sauvegarde sous forme de .npy
    """

    # Charger les poids par défaut et les transformations associées
...
if __name__ == "__main__":
    precompute_images_vit(
        input_dir='./datasets',
        output_dir='./data_npy_vit'
    )
